...
impl Request {
    ...
    pub fn get_lin_read(&self) -> &LinRead {
        self.lin_read
            .as_ref()
            .unwrap_or_else(|| <LinRead as ::protobuf::Message>::default_instance())
    }
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<LinRead>,
                >(
                    "lin_read",
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<SchemaNode>,
                >(
                    "schema",
                    |m: &Response| &m.schema,
...
impl ::protobuf::Message for Assigned {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<Assigned>(
                "Assigned",
                fields,
                file_descriptor_proto(),
            )
    ...
    fn default_instance() -> &'static Assigned {
        static instance: ::protobuf::rt::LazyV2<Assigned> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for LinRead {
    ...
    fn write_to_with_cached_sizes(
        ...
        >(1, &self.ids, os)?;
        if self.sequencing != LinRead_Sequencing::CLIENT_SIDE {
            os.write_enum(2, ::protobuf::ProtobufEnum::value(&self.sequencing))?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_map_accessor::<
                ...
                ::protobuf::types::ProtobufTypeUint64,
            >(
                "ids", |m: &LinRead| &m.ids, |m: &mut LinRead| &mut m.ids
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<LinRead_Sequencing>,
            >(
                "sequencing",
                |m: &LinRead| &m.sequencing,
                |m: &mut LinRead| &mut m.sequencing,
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<LinRead>(
                "LinRead",
                fields,
                file_descriptor_proto(),
            )
    ...
    fn default_instance() -> &'static LinRead {
        static instance: ::protobuf::rt::LazyV2<LinRead> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::ProtobufEnum for LinRead_Sequencing {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<LinRead_Sequencing>(
                "LinRead.Sequencing",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::Message for SchemaNode {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<SchemaNode>(
                "SchemaNode",
                fields,
                file_descriptor_proto(),
            )
    ...
    fn default_instance() -> &'static SchemaNode {
        static instance: ::protobuf::rt::LazyV2<SchemaNode> = ::protobuf::rt::LazyV2::INIT;
